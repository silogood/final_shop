...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public ShoesNote getShoesNote(long id) {
        ...
        Cursor cursor = db.query(ShoesNote.TABLE_NAME_SHOES,
                new String[]{ShoesNote.COLUMN_NAME, ShoesNote.COLUMN_CODE, ShoesNote.COLUMN_BQT, ShoesNote.COLUMN_TIMESTAMP},
                ShoesNote.COLUMN_CODE + "=?",
    ...
    public AccNote getAccNote(long id) {
        ...
        Cursor cursor = db.query(AccNote.TABLE_NAME_ACC,
                new String[]{AccNote.COLUMN_CODE, AccNote.COLUMN_NAME, AccNote.COLUMN_CODE, AccNote.COLUMN_BQT, AccNote.COLUMN_TIMESTAMP},
                AccNote.COLUMN_CODE + "=?",
                new String[]{String.valueOf(id)}, null, null, null, null);
    ...
    public List<ShoesNote> getAllShoesNotes() {
    ...
    public List<AccNote> getAllAccNotes() {
    ...
    public int updateShoesNoteBycode(ShoesNote note) {
        SQLiteDatabase db = this.getWritableDatabase();

        ContentValues values = new ContentValues();
        values.put(ShoesNote.COLUMN_NAME, note.getName());
        values.put(ShoesNote.COLUMN_BQT, note.getBqt());
        values.put(ShoesNote.COLUMN_TIMESTAMP, note.getTimestamp());

        // updating row
        return db.update(ShoesNote.TABLE_NAME_SHOES, values, ClothesNote.COLUMN_CODE + " = ?",
                new String[]{note.getCode()});
    }

    public int updateAccNoteBycode(AccNote note) {
        SQLiteDatabase db = this.getWritableDatabase();

        ContentValues values = new ContentValues();
        values.put(AccNote.COLUMN_NAME, note.getName());
        values.put(AccNote.COLUMN_BQT, note.getBqt());
        values.put(AccNote.COLUMN_TIMESTAMP, note.getTimestamp());

        // updating row
        return db.update(AccNote.TABLE_NAME_ACC, values, ClothesNote.COLUMN_CODE + " = ?",
                new String[]{note.getCode()});
    }
    ...
    public void deleteShoesNote(ShoesNote note) {
        SQLiteDatabase db = this.getWritableDatabase();
        db.delete(ShoesNote.TABLE_NAME_SHOES, ShoesNote.COLUMN_CODE + " = ?",
                new String[]{note.getCode()});
        db.close();
    }
    public void deleteAccNote(AccNote note) {
        SQLiteDatabase db = this.getWritableDatabase();
        db.delete(AccNote.TABLE_NAME_ACC, AccNote.COLUMN_CODE + " = ?",
                new String[]{note.getCode()});
        db.close();
    }
    ...
    public void deleteShoesNotebyname (String code){
        SQLiteDatabase db = this.getWritableDatabase();

        int result = db.delete(ShoesNote.TABLE_NAME_SHOES, ShoesNote.COLUMN_CODE + " = ?",
                new String[]{code});
        Log.d(TAG, "###SILOGOOD 2 result : " + result);
        db.close();
    }

    public void deleteAccNotebyname (String code){
        SQLiteDatabase db = this.getWritableDatabase();

        int result = db.delete(AccNote.TABLE_NAME_ACC, AccNote.COLUMN_CODE + " = ?",
                new String[]{code});
        Log.d(TAG, "###SILOGOOD 3 result : " + result);
        db.close();
    }
